...
out_path = '/home/liyr/HuBMAP/RNA_velocity_result/DeepVelo_SA/'
out_file = os.listdir(out_path)

file_path2 = [item for item in file_list if item not in out_file]
print(file_path2)
...
for file in file_list:
    try :
        ...
        XYpath = "sup_result/DeepVelo_SA_prepropcessed.npz"
        np.savez(XYpath, X, Y)
