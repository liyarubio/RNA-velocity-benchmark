...
os.makedirs('/home/liyr/HuBMAP/RNA_velocity_result/TFvelo/',exist_ok=True)
kk = 0
for file in file_list:
    kk = kk +1
    print('run: {} / {}'.format(kk, len(file_list)))
    adata = sc.read_h5ad(file_path+file)

    run_tfvelo(adata,'CytoTRACE2_Potency')
    folder_path = '/home/liyr/HuBMAP/RNA_velocity_result/TFvelo/{}'.format(file)
