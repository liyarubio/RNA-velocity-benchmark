...
fwrite(df,'/media/liyaru/LYR/Benchmark/Redeem/eval_csv/all_eval_CBDir_reorder.csv')
...
metrics <- fread('/media/liyaru/LYR/Benchmark/Redeem/eval_csv/all_eval_8.csv') %>%
  as.data.frame()

colnames(metrics)[4] <- 'Method'
metrics <- check_method_name(metrics)

fwrite(metrics,'/media/liyaru/LYR/Benchmark/Redeem/eval_csv/all_eval_reorder.csv')
