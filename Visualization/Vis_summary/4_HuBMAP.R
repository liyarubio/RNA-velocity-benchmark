...
####-------all-------------------
HuBMAP <- fread('/media/liyaru/LYR/Benchmark/HuBMAP/new_hubmap_global_all.tsv') %>% as.data.frame()
...
HuBMAP2 <- t(HuBMAP) %>% as.data.frame()
fwrite(HuBMAP2,'/media/liyaru/LYR/Benchmark/HuBMAP/new_hubmap_global_all_reorder.csv',row.names = T)
