...
fwrite(df_summ,'/media/liyaru/LYR/Benchmark/dyngen/eval_data_1030/eval_data/cell_level/cosine_sim_scatter.csv') 
...
fwrite(df_merge,'/media/liyaru/LYR/Benchmark/dyngen/eval_data_1030/eval_data/cell_level/cosine_sim_violin.csv')

df_merge_long <- melt(df_merge, id.vars = c("Method_Dataset"), 
                      variable.name = "Dim", value.name = "Cosine_sim")
fwrite(df_merge_long,'/media/liyaru/LYR/Benchmark/dyngen/eval_data_1030/eval_data/cell_level/cosine_sim_violin_long.csv')
